...
namespace ProblemSolvers.TestData.TestCases.Experiment6
{
    public class Experiment_6 : IExperiment
    {
        public void RunExperiment()
        {
            ...
            var GAdataCVRP = new GeneticAlgorithmGenericData(GenerationsAmount: 100, PopulationSize: 500, CrossoverProbability: 0.7, MutationProbability: 0.1, maxFitnessCount);
            ...
            var SAdataCVRP = new SimulatedAnnealingGenericData(1000, 2.0, 0.0001, 0.99, maxFitnessCount);

            // setup the solver
            var crossovererCVRP = new OrderedCrossoverer();
            var mutatorCVRP = new InvertedCombinationMutator();

            var runner = new CVRProblemRunner(cvrpEasyOne, GAdataCVRP, RSdataCVRP, SAdataCVRP, SelectionType.Tournament, crossovererCVRP, mutatorCVRP, 5, sourceFileEasyAn32k5, 10, true);
            runner.RunProblem();
        }
    }
}
