...
namespace ProblemSolvers.TestData.TestCases.Experiments
{
    public class Experiment_3 : IExperiment
    {
        public void RunExperiment()
        {
            ...
            var GAdataCVRP = new GeneticAlgorithmGenericData(GenerationsAmount: 100, PopulationSize: 100, CrossoverProbability: 0.1, MutationProbability: 0.1, maxFitnessCount);
